...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="javascript:void(0);" class="btn-aqua" nc_type="dialog" dialog_title="接收设置" dialog_id="msg_setting" dialog_width="480" uri="<?php echo urlShop('store_msg', 'edit_msg_setting', array('code'=>$val['smt_code']));?>"><i class="icon-cog"></i>
        <p>设置</p>
        </a></span></td>
    </tr>
    <?php } ?>
