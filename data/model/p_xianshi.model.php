...
class p_xianshiModel extends Model{
     ...
     *
     */
    public function getXianshiList($condition, $page=null, $order='', $field='*', $limit=0) {
        $xianshi_list = $this->field($field)->where($condition)->limit($limit)->page($page)->order($order)->select();
