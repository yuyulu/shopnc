...
<tr><td colspan="4" style="border-bottom:1px solid #ccc"><h3 style="font-size:20px;line-height:60px"><?php echo C('site_name');?> - 虚拟订单商家结算单</h3></td></tr>
<tr>
...
<tr><td>结算明细</td><td colspan="3"><?php echo $output['bill_info']['ob_order_totals'];?> (消费金额) - <?php echo $output['bill_info']['ob_commis_totals'];?> (佣金金额)</td></tr>
</table>