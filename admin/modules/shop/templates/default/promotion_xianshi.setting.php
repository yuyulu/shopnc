  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=promotion_xianshi&op=xianshi_setting_save">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="promotion_xianshi_price" name="promotion_xianshi_price" value="<?php echo $output['setting']['promotion_xianshi_price'];?>" class="input-txt">
          <span class="err"></span>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
      		promotion_xianshi_price: {
       			required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['xianshi_price_error'];?>',
       			digits : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['xianshi_price_error'];?>',
                min : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['xianshi_price_error'];?>'
            }
        }
	});
});
