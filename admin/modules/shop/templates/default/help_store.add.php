...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=help_store&op=help_store" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>店铺帮助 - <?php echo $lang['nc_new'];?></h3>
        <h5>商品店铺帮助类型与文章管理</h5>
      </div>
    </div>
  </div>
  <form id="post_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input id="help_title" name="help_title" value="" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="255" name="help_sort" id="help_sort" class="input-txt">
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="" name="help_url" id="help_url" class="input-txt">
          <span class="err"></span>
          ...
          <div id="thumbnails" class="ncap-thumb-list">
            ...
            <ul>
              ...
              <li id="pic_<?php echo $val['upload_id'];?>">
                ...
                <a href="javascript:del_file_upload('<?php echo $val['upload_id'];?>');" class="del" title="<?php echo $lang['nc_del'];?>">X</a><a href="javascript:insert_editor('<?php echo $val['file_name'];?>');" class="inset"><i class="fa fa-trash"></i>插入图片</a> </li>
              <?php } ?>
              <?php } ?>
            </ul>
          </div>
