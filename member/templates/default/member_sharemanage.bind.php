...
<div class="wrap">
  ...
  <ul class="bind-account-list">
    ...
    <li>
      <div class="account-item"><span class="website-icon"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/shareicon/shareicon_<?php echo $k;?>.png"></span>
        <dl>
          ...
          <dd class="operate">
            ...
            <?php }else {?>
            <a class="ncbtn ncbtn-mint" nc_type="bindbtn" data-param='{"apikey":"<?php echo $k;?>","apiname":"<?php echo $v['name'];?>"}' href="javascript:void(0);"><?php echo $lang['sharebind_list_immediatelybind'];?></a>
            <?php }?>
          </dd>
        </dl>
      </div>
...
$(function(){
	...
	$("[nc_type='unbindbtn']").bind('click',function(){
	    ...
	    ajax_get_confirm(confirm_tip,'<?php echo MEMBER_SITE_URL;?>/index.php?act=member_sharemanage&op=unbind&type='+data_str.apikey);
	});
