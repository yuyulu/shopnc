...
<div class="top" style="overflow: hidden;">
  ...
  <div class="ncs-cosult-askbtn"><a href="<?php echo urlShop('goods', 'consulting_list', array('goods_id' => $_GET['goods_id']));?>#askQuestion" target="_blank" class="ncbtn ncbtn-grapefruit">我要提问</a></div>
</div>
