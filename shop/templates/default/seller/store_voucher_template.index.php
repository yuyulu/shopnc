...
<?php if ($output['isOwnShop']) { ?>
    ...
    <a class="ncbtn ncbtn-mint" href="<?php echo urlShop('store_voucher', 'templateadd');?>"><i class="icon-plus-sign"></i><?php echo $lang['voucher_templateadd']; ?></a>
<?php } else { ?>
    ...
    <a class="ncbtn ncbtn-mint" style="right:100px" href="<?php echo urlShop('store_voucher', 'templateadd');?>"><i class="icon-plus-sign"></i><?php echo $lang['voucher_templateadd']; ?></a>
	...
	<table class="search-form">
		...
		<tr>
			...
			<td class="w120"><select class="w80" name="gettype_sel">
					<option value=""
						<?php if (!$_GET['gettype_sel']){ echo 'selected=true';}?>><?php echo $lang['nc_please_choose'];?></option>
