...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=return&op=get_manage_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });
    // 高级搜索重置
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?act=return&op=get_manage_xml',
        colModel : [
