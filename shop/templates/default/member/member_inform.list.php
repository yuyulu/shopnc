  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><span><a href="index.php?act=member_inform&op=inform_info&inform_id=<?php echo $val['inform_id']; ?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
          <p><?php echo $lang['nc_view'];?></p>
          </a></span>
          <?php if($val['inform_state']==='1') { ?>
          <span><a class="btn-bittersweet" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['inform_cancel_confirm'];?>', 'index.php?act=member_inform&op=inform_cancel&inform_id=<?php echo $val['inform_id']; ?>');"><i class="icon-ban-circle"></i>
