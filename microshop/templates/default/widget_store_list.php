...
<div class="microshop-store-list">
  ...
  <!-- 喜欢删除按钮 -->
  <div class="del"><a nc_type="like_drop" like_id="<?php echo $output['like_store_list'][$value['microshop_store_id']]['like_id'];?>" href="javascript:void(0)" title="<?php echo $lang['nc_delete'];?>">&nbsp;</a></div>
  <?php } ?>
  <?php } ?>
