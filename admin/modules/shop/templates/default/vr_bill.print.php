...
<tr><td>结算明细</td><td colspan="4"> <?php echo ncPriceFormat($output['bill_info']['ob_order_totals']);?> (消费金额) - <?php echo ncPriceFormat($output['bill_info']['ob_commis_totals']);?> (佣金金额) </td></tr>
</table>