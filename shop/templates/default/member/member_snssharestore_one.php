  ...
  <form method="post" action="index.php?act=member_snsindex&op=sharestore" id="sharestore_form">
    ...
    <div class="share-content">
      ...
      <div class="share-goods">
        <div class="goods-thumb"><a target="_blank" href="<?php echo $output['store_info']['store_url'];?>"><img title="<?php echo $output['store_info']['store_name']; ?>" src="<?php echo getStoreLogo($output['store_info']['store_avatar']);?>"/></a></div>
