  ...
  <div id="gallery" class="ad-gallery">
    ...
    <div class="ad-image-date">
      ...
      <dd>
        ...
        <p><?php echo $lang['album_pinfo_see_src']?><span><a href="JavaScript:void(0);" target="_blank" id="default_popup"  class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span></p>
        <p><?php echo $lang['album_pinfo_see_max']?><span><a href="JavaScript:void(0);" target="_blank" id="max_popup" class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span></p>
        <p><?php echo $lang['album_pinfo_see_mid']?><span><a href="JavaScript:void(0);" target="_blank" id="mid_popup" class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span></p>
        <p><?php echo $lang['album_pinfo_see_small']?><span><a href="JavaScript:void(0);" target="_blank" id="small_popup" class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span></p>
        <p><?php echo $lang['album_pinfo_see_tiny']?><span><a href="JavaScript:void(0);" target="_blank" id="tiny_popup" class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span></p>
      </dd>
    </div>
...
<script>
  $(function() {
	...
	$("#default_popup").click(function(){
		...
		<?php if (C('oss.open')) { ?>
		pic = pic.replace('@!product-1280','');
		<?php } else { ?>
		pic = pic.replace('_1280.'+img_type,'')+ '.' + img_type;		
        <?php } ?>
