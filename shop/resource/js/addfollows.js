...
$(function(){
	...
	check_tuwen(1);
	var url = "index.php?act=seller_wechat&op=showfollow";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = "index.php?act=seller_wechat&op=addfollow";
		...
		var url = "index.php?act=seller_wechat&op=addfollow";
		//var url = "/biz.php?ctl=wechat&act=addfollow";
				    ...
				    success: function (data, status)
				    {
						...
						$(obj).parent().find(".fileuploading").addClass("hide");
				   		if(data.status==1)
				   		{
							...
							//var img_url = 'http://shopnc.dev:550'+data.big_url;
							//var mid_url = 'http://shopnc.dev:550'+data.mid_url;
						    if(0==zsc_count){ //大图
