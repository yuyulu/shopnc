    ...
    <div class="ncap-form-default">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <?php } ?>
                &nbsp;&nbsp;&nbsp;&nbsp;<a class="ncap-btn-big ncap-btn-green" href="javascript:void(0);" id="updategoods_btn">更新商品保障服务信息</a></dd>
        </dl>
    </div>
...
<script>
$(function(){
    var flexUrl = 'index.php?act=contract&op=contractlog_xml&item_id=<?php echo $output['c_info']['ct_itemid'];?>&store_id=<?php echo $output['c_info']['ct_storeid'];?>';
    $("#flexigrid").flexigrid({
        url: flexUrl,
        colModel: [
