...
<div class="ncsc-flow-item">
  ...
  <div class="item-goods">
    ...
    <dl>
      ...
      <dd><a href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <?php echo $val['goods_name']; ?> </a> <?php echo $lang['currency'];?><?php echo ncPriceFormat($val['goods_price']);?>&nbsp;*&nbsp;<?php echo $val['goods_num'];?><font color="#AAA">(<?php echo $lang['complain_text_num'];?>)</font>
