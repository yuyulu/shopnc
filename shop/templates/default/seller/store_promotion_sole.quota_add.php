...
<div class="ncsc-form-default">
  ...
  <form id="add_form" action="<?php echo urlShop('store_promotion_sole', 'sole_quota_add');?>" method="post">
  <?php } else {?>
  <form id="add_form" action="<?php echo urlShop('store_promotion_sole', 'sole_renew');?>" method="post">
  <?php }?>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint"><?php printf('每月您需要支付%d元。', intval(C('promotion_sole_price')));?></p>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		submitHandler:function(form){
			var unit_price = parseInt(<?php echo C('promotion_sole_price');?>);
