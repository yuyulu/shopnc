...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="<?php echo urlShop('store_navigation', 'navigation_add');?>" class="ncbtn ncbtn-mint" title="添加导航">添加导航</a> </div>
  <table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_navigation', 'navigation_edit', array('sn_id' => $value['sn_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
          <p> <?php echo $lang['nc_edit'];?></p>
          </a></span><span> <a href="javascript:;" nctype="btn_del" data-sn-id="<?php echo $value['sn_id'];?>"class="btn-grapefruit"><i class="icon-trash"></i>
