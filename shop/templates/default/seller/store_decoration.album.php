...
<div class="ncsc-gallery">
  <ul>
    ...
    <li>
      ...
      <div class="pic-handle"><span><?php echo $value['upload_time_format'];?></span><a nctype="btn_del_image" href="javascript:void(0);" data-image-id="<?php echo $value['image_id'];?>" class="ncbtn-mini"><i class="icon-trash"></i>删除</a></div>
    </li>
    <?php } ?>
  </ul>
</div>
