...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=promotion_book&op=get_quota_xml',
        colModel: [
            ...
            {display: '开始时间', name: 'bkq_starttime', width: 120, sortable: false, align: 'center'},
            {display: '结束时间', name: 'bkq_endtime', width: 120, sortable: false, align: 'center'}
        ],
        searchitems: [
            {display: '店铺ID', name: 'store_id'},
            {display: '店铺名称', name: 'store_name'}
        ],
        sortname: "bkq_endtime",
        sortorder: "desc",
        title: '预售商品套餐列表'
    });
});
