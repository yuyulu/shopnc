...
<ul class="brands dialog-brandslist-s2">
  ...
  <li>
    <div class="brands-pic" onclick="select_brand(<?php echo $v['brand_id'];?>);"><span class="ac-ico"></span><span class="thumb size-88x29"><i></i><img brand_id="<?php echo $v['brand_id'];?>" title="<?php echo $v['brand_name'];?>" brand_name="<?php echo $v['brand_name'];?>" src="<?php if(!empty($v['brand_pic'])){ echo UPLOAD_SITE_URL.'/'.ATTACH_BRAND.'/'.$v['brand_pic'];}else{ echo ADMIN_SITE_URL.'/templates/'.TPL_NAME.'/images/default_brand_image.gif';}?>" onload="javascript:DrawImage(this,88,30);" /></span></div>
