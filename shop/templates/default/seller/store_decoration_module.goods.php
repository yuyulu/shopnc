...
<ul class="goods-list">
  ...
  <li nctype="goods_item" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-price="<?php echo ncPriceFormat($val['goods_price']);?>"  data-goods-image="<?php echo $val['goods_image'];?>">
    ...
    <dl class="goods-info">
      ...
      <dd><?php echo $lang['currency'].ncPriceFormat($val['goods_price']);?></dd>
    </dl>
    <?php if(!empty($output['goods_list'])) { ?>
    <a nctype="btn_module_goods_operate" class="ncbtn-mini" href="javascript:;"><i class="icon-plus"></i>选择添加</a>
    <?php } ?>
  </li>
  <?php } ?>
</ul>
