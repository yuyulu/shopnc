    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="bdr"><?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 1) { ?>
          <p><a href="index.php?act=member_return&op=ship&return_id=<?php echo $val['refund_id']; ?>" class="ncbtn">退货</a></p>
          <?php } else { ?>
          <a href="index.php?act=member_return&op=view&return_id=<?php echo $val['refund_id']; ?>" class="ncbtn">查看</a>
          <?php } ?>
          <?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 3) { ?>
          <p><a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" nc_type="dialog" dialog_title="延迟时间" dialog_id="return_delay" dialog_width="480"
