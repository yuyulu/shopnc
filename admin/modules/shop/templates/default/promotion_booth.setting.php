...
<div class="page">
  ...
  <form id="add_form" method="post" action="<?php echo urlAdminShop('promotion_booth', 'booth_setting');?>">
    <input type="hidden" id="form_submit" name="form_submit" value="ok" />
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="promotion_booth_price"><em>*</em>购买单价（元/月）</label>
        </dt>
        <dd class="opt">
          <input type="text" id="promotion_booth_price" name="promotion_booth_price" value="<?php echo $output['setting']['promotion_booth_price'];?>" class="input-txt">
          <span class="err"></span>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="promotion_booth_goods_sum"><em>*</em>允许推荐商品最大数量</label>
        </dt>
        <dd class="opt">
          <input type="text" id="promotion_booth_goods_sum" name="promotion_booth_goods_sum" value="<?php echo $output['setting']['promotion_booth_goods_sum'];?>" class="input-txt">
          <span class="err"></span>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		messages : {
		    promotion_booth_price: {
				required : '<i class="fa fa-exclamation-circle"></i>请填写展位价格',
				digits : '<i class="fa fa-exclamation-circle"></i>请填写展位价格'
			},
			promotion_booth_goods_sum: {
