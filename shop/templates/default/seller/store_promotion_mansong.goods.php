...
</dt><dd>销售价：<?php echo $lang['currency'].ncPriceFormat($val['goods_price']);?></dl>
<a nctype="btn_add_mansong_goods" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-image-url="<?php echo $goods_image_url;?>" data-goods-url="<?php echo $goods_url;?>" href="javascript:void(0);" class="ncbtn-mini ncbtn-mint"><i class="icon-ok-circle "></i>选择为礼品</a>
</li>
<?php } ?>
</ul>
