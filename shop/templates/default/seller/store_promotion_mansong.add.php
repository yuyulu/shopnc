...
<?php } ?>
    ...
    <dl>
      ...
      <dd>
        ...
        <a href="javascript:void(0);" id="btn_add_rule" class="ncbtn ncbtn-aqua"><i class="icon-plus-sign"></i>添加规则</a>
        ...
        <span>送礼品&nbsp;<a href="javascript:void(0);" id="btn_show_search_goods" class="ncbtn"><i class="icon-gift"></i>选择礼品</a></span> <div id="mansong_goods_item" class="gift"></div>
        ...
        <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
                    <table class="search-form">
                        <tr>
                            ...
                            <td class="w70 tc">
                                <a href="javascript:void(0);" id="btn_search_goods" class="ncbtn"/><i class="icon-search"></i><?php echo $lang['nc_search'];?></a>
                            </td>
                            <td class="w10"></td>
                            <td>
            ...
            <div class="mt10">
            <a href="javascript:void(0);" id="btn_save_rule" class="ncbtn ncbtn-aqua"><i class="icon-ok-circle"></i>确定规则设置</a>
            <a href="javascript:void(0);" id="btn_cancel_add_rule" class="ncbtn ncbtn-bittersweet"><i class="icon-ban-circle"></i>取消</a></div>
        </div>
        <span class="error-message"></span>
