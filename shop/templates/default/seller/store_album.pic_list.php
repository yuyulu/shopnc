    ...
    <tbody>
      <tr>
        ...
        <td><?php if(is_array($output['pic_list']) && !empty($output['pic_list'])){?>
          <a href="JavaScript:void(0);" class="ncbtn-mini" onClick="checkAll()"><i class="icon-check"></i><?php echo $lang['album_plist_check_all'];?></a><a href="JavaScript:void(0);" class="ncbtn-mini" onClick="uncheckAll()"><i class="icon-check-sign"></i><?php echo $lang['album_plist_cancel'];?></a><a href="JavaScript:void(0);" class="ncbtn-mini" onClick="switchAll()"><i class="icon-check-empty"></i><?php echo $lang['album_plist_inverse'];?></a><a href="JavaScript:void(0);" class="ncbtn-mini" onClick="submit_form('del')"><i class="icon-trash"></i><?php echo $lang['album_class_delete'];?></a><a href="JavaScript:void(0);" class="ncbtn-mini" id="img_move"><i class="icon-move"></i><?php echo $lang['album_plist_move_album'];?></a>
          <?php if (!C('oss.open')) { ?>
          <a href="JavaScript:void(0);" class="ncbtn-mini" onClick="submit_form('watermark')"><i class=" icon-paste"></i><?php echo $lang['album_plist_add_watermark'];?></a>
          <?php } ?>
