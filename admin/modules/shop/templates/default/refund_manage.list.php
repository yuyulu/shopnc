...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=refund&op=get_manage_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });
    // 高级搜索重置
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?act=refund&op=get_manage_xml',
        colModel : [
            ...
            {display: '商家处理时间', name : 'seller_time', width: 120, sortable : true, align : 'center'},
