...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('mall_consult', 'type_list');?>" title="返回平台咨询类型列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>平台客服 - 编辑类型“<?php echo $output['mct_info']['mct_name'];?>”</h3>
  ...
  <form method="post" name="form_typeadd" id="form_typeadd">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input class="input-txt" type="text" name="mct_name" value="<?php echo $output['mct_info']['mct_name'];?>" />
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <?php showEditor('mct_introduce', $output['mct_info']['mct_introduce']);?>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <input class="input-txt" type="text" name="mct_sort" value="<?php echo $output['mct_info']['mct_sort'];?>" />
          <span class="err"></span>
