  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="normal_form">
      ...
      <dd>
        ...
        <div class="handle">
          <div class="ncsc-upload-btn"> <a href="javascript:void(0);"><span>
            ...
            <a class="ncbtn mt5" nctype="get_img" href="index.php?act=store_album&op=pic_list&item=store_sns_normal"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_img" class="ncbtn ml5 mt5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"normal"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> <span id="weibocharcount_normal" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="recommend_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"><a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"recommend"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_recommend" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="hotsell_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"> <a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"hotsell"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_hotsell" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="new_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"> <a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"new"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_new" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
