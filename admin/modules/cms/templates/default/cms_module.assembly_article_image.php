...
<div class="cms-module-assembly-article-image">
    ...
    <div class="content-box">
        ...
        <?php echo "<?php if(\$output['edit_flag']) { ?>";?>
        <div class="cms-index-module-handle"><a nctype="btn_module_article_edit" save_function="article_type_3_save" limit_count="0" href="JavaScript:void(0);" class="tip-l" title="<?php echo $lang['cms_index_module_article_image_edit'];?>"><?php echo $lang['cms_index_module_article_image_edit'];?></a></div>
        <?php echo "<?php } ?>";?>
    </div>
</div>
