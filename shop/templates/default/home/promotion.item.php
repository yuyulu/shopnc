...
<div class="item">
  <div class="scope">
    ...
    <div class="goods-buy"><a href="javascript:void(0);" nctype="add_cart" data-gid="<?php echo $goods_info['goods_id'];?>" class="btn">立即抢购</a> <span class="raty" data-score="<?php echo $goods_info['evaluation_good_star'];?>" style="width: 100px;"></span> <span class="mt5"><a href="<?php echo urlShop('show_store','index',array('store_id'=>$goods_info['store_id']));?>"><?php echo $goods_info['store_name'];?></a></span> </div>
    <ul class="goodseval">
