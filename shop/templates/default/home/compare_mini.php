...
<ul class="goods-list">
  ...
  <li><dl class="goods-info">
    ...
    <dd class="goods-price"><?php echo $lang['currency'].ncPriceFormat($v['goods_promotion_price']);?><span class="del" onclick="javascript:delCompare(<?php echo $v['goods_id'];?>,'mini');">删除</span></dd> </dl>
  </li>
  <?php } ?>
  <?php } ?>
...
<div class="btn-box">
  ...
  <span style="background-color: #F32613; color: #FFFFFF; cursor: pointer; padding: 5px 10px;" onclick="javascript:window.open('index.php?act=compare&gids=<?php echo $output['goodsid_str'];?>');">对比</span>
