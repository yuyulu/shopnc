...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=type&op=type" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['nc_type_manage'];?> - <?php echo $lang['nc_new'];?></h3>
    ...
    <div class="ncap-form-default">
            ...
            <div class="ncap-type-spec-list">
              ...
              <dl>
                ...
                <dd>
                  ...
                  <label>
                    <input class="checkitem" nc_type="change_default_spec_value" type="checkbox" value="<?php echo $v['sp_id'];?>" name="spec_id[]">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <a id="add_type" class="ncap-btn" href="JavaScript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['type_add_attr_add_one'];?></a> </dd>
      </dl>
      <dl class="row">
