  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="index.php?act=store_complain&op=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-bittersweet"><i class="icon-eye-open"></i>
