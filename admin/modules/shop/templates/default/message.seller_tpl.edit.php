...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=message&op=seller_tpl" title="返回商家消息模板列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['nc_message_set'];?> - <?php echo $lang['nc_edit'];?>商家消息模板“<?php echo $output['smtpl_info']['smt_name'];?>”</h3>
    ...
    <form class="tab-content" method="post" name="message_form" >
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="message_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_message_forced'] == 1){?>selected<?php }?>"><?php echo $lang['nc_yes'];?></label>
              <label for="message_forced0" class="cb-disable <?php if($output['smtpl_info']['smt_message_forced'] == 0){?>selected<?php }?>"><?php echo $lang['nc_no'];?></label>
    ...
    <form class="tab-content" method="post" name="short_name" style="display:none;">
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="short_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_short_forced'] == 1){?>selected<?php }?>"><?php echo $lang['nc_yes'];?></label>
              <label for="short_forced0" class="cb-disable <?php if($output['smtpl_info']['smt_short_forced'] == 0){?>selected<?php }?>"><?php echo $lang['nc_no'];?></label>
    ...
    <form class="tab-content" method="post" name="mail_form" style="display:none;">
      ...
      <div class="ncap-form-default">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="mail_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_mail_forced'] == 1){?>selected<?php }?>"><?php echo $lang['nc_yes'];?></label>
              <label for="mail_forced0" class="cb-disable <?php if($output['smtpl_info']['smt_mail_forced'] == 0){?>selected<?php }?>"><?php echo $lang['nc_no'];?></label>
