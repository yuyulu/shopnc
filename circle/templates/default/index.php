  ...
  <div class="layout-r">
    ...
    <dl class="member-no-login">
      ...
      <dd class="quick-link"> <?php echo $lang['circle_login_prompt_one'];?><a href="javascript:void(0);" nctype="login" class="url">[<?php echo $lang['nc_login'];?>]</a><?php echo $lang['circle_login_prompt_two'];?><br/>
        <?php echo $lang['circle_register_prompt_one'];?><a href="<?php echo urlLogin('login', 'register', array('ref_url' => getRefUrl()));?>" class="url">[<?php echo $lang['nc_register'];?>]</a><?php echo $lang['circle_register_prompt_two'];?></dd>
    </dl>
    <?php }else{?>
    <dl class="member-me-info">
      <dt class="member-name"><?php echo $_SESSION['member_name'];?></dt>
      <dd class="avatar"><img src="<?php  echo getMemberAvatarForID($_SESSION['member_id']);?>" /><a href="<?php echo urlMember('member_information', 'avatar');?>" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></dd>
      ...
      <dd class="quick-link"> <a target="_blank" href="index.php?act=p_center&op=my_group" class="url"><?php echo $lang['my_circle'];?></a> <a href="index.php?act=p_center" class="url"><?php echo $lang['my_theme'];?></a> <a href="<?php echo urlLogin('login','logout');?>" class="url"><?php echo $lang['nc_logout'];?></a> </dd>
    </dl>
    <?php }?>
