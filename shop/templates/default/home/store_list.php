...
<div class="nc-store-class">
  ...
  <dl>
    ...
    <dd>
      <a href="<?php echo urlShop('store_list','index');?>">所有店铺</a>
...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="shop-info">
        ...
        <dd class="shopkeeper"><?php echo $lang['store_class_index_owner'].$lang['nc_colon'];?><?php echo $store['member_name'];?><a target="_blank" class="message" href="index.php?act=member_message&op=sendmsg&member_id=<?php echo $store['member_id'];?>"></a><dd>
	...
	<span member_id="<?php echo $store['member_id'];?>"></span>
	 ...
	 <?php }?>
      ...
      <div class="nc-shop-goodslist" nc_type='goods_<?php echo $skey;?>'>
        ...
        <li>
            <dl>
              <dt class="goods-pic"><span class="thumb size160"> <i></i> <a href="index.php?act=goods&goods_id=<?php echo $v['goods_id'];?>" target="_blank"> <img  onload="javascript:DrawImage(this,160,160);" alt="<?php echo $v['goods_name'];?>" width="160" height="160"  src="<?php echo thumb($v,'small');?>"></a></span></dt>
