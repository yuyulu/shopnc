...
<div class="ncp-member-point">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_voucher&op=index" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_pointorder&op=orderlist" target="_blank">
