    ...
    <div id="dialog_edit_head_tabs_1">
      ...
      <dl>
        ...
        <dd>
          ...
          <p> <a id="btn_default_nav_style" class="ncbtn-mini" href="javascript:void(0);"><i class="icon-refresh"></i>恢复默认</a> </p>
    ...
    <div id="dialog_edit_head_tabs_2">
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="hint">选择上传头部图片，建议使用宽度为1200像素，大小不超过1M的gif\jpg\png格式图片。</p>
        </dd>
      </dl>
      <div class="bottom">
...
<div id="dialog_module_slide" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <dl class="display-set">
    ...
    <dd><span>全屏显示
      ...
      <p><a id="btn_add_slide_image" class="ncbtn mt5" href="javascript:void(0);"><i class="icon-plus"></i>添加图片</a></p>
    </dd>
  </dl>
    ...
    <form action="">
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="mt5"><a id="btn_save_add_slide_image" class="ncbtn ncbtn-aqua" href="javascript:void(0);">添加</a> <a id="btn_cancel_add_slide_image" class="ncbtn ncbtn-bittersweet" href="javascript:void(0);">取消</a></p>
        </dd>
      </dl>
    </form>
  </div>
...
<div id="dialog_module_hot_area" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <dl>
    ...
    <dd>
      ...
      <a id="btn_module_hot_area_add" class="ncbtn ml5" href="javascript:void(0);"><i class="icon-anchor"></i>添加网址</a>
...
<div id="dialog_module_goods" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <div class="decoration-search-goods">
    <div class="search-bar">输入商品关键字：
      ...
      <a id="btn_module_goods_search" class="ncbtn" href="javascript:void(0);">搜索</a><span class="ml10 orange">小提示： 留空搜索显示店铺全部在售商品，每页显示10个。</span></div>
...
<i></i>
<p>热点区域<%=index%></p>
<p><a nctype="btn_module_hot_area_select" data-hot-area-position="<%=position%>" class="ncbtn-mini ncbtn-aqua" href="javascript:void(0);">选择</a>
<a data-index="<%=index%>" nctype="btn_module_hot_area_del" class="ncbtn-mini ncbtn-grapefruit" href="javascript:void(0);">删除</a></p>
</li>
</script> 
<!-- 热点块标识模板 --> 
