...
<ul class="cart-list">
  ...
  <li ncTpye="cart_item_<?php echo $v['cart_id'];?>">
    <div class="goods-pic"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank";><img src="<?php echo $v['goods_image'];?>" alt="<?php echo $v['goods_name'];?>"/></a></div>
    <dl>
