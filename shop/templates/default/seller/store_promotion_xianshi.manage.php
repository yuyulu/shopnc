...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#div_goods_search_result').on('click', '[nctype="btn_add_xianshi_goods"]', function() {
            ...
            $('#dialog_add_xianshi_goods').nc_show_dialog({width: 640, title: '限时折扣商品规则设定'});
...
<div class="tabmenu">
    ...
    <a id="btn_show_goods_select" class="ncbtn ncbtn-mint" href="javascript:;"><i></i><?php echo $lang['goods_add'];?></a> </div>
    <?php } ?>
...
<table class="ncsc-default-table">
  ...
  <tbody id="xianshi_goods_list">
    ...
    <tr class="bd-line">
        ...
        <td><?php echo $lang['currency']; ?><span nctype="xianshi_price"><?php echo $val['xianshi_price'];?></span></td>
        <td><span nctype="xianshi_discount"><?php echo $val['xianshi_discount'];?></span></td>
        <td class="nscs-table-handle">
        <?php if($output['xianshi_info']['editable']) { ?>
        <span><a nctype="btn_edit_xianshi_goods" class="btn-bluejeans" data-xianshi-goods-id="<?php echo $val['xianshi_goods_id']?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);"><i class="icon-edit"></i><p><?php echo $lang['nc_edit'];?></p></a></span>
            <span><a nctype="btn_del_xianshi_goods" class="btn-grapefruit" data-xianshi-goods-id="<?php echo $val['xianshi_goods_id']?>" href="javascript:void(0);"><i class="icon-trash"></i><p><?php echo $lang['nc_del'];?></p></a></span>
        <?php } ?>
        </td>
    </tr>
    <?php }?>
...
<tr class="bd-line">
    ...
    <td class="nscs-table-handle">
    <?php if($output['xianshi_info']['editable']) { ?>
    <span><a nctype="btn_edit_xianshi_goods" class="btn-bluejeans" data-xianshi-goods-id="<%=xianshi_goods_id%>" data-goods-price="<%=goods_price%>" href="javascript:void(0);"><i class="icon-edit"></i><p><?php echo $lang['nc_edit'];?></p></a></span>
        <span><a nctype="btn_del_xianshi_goods" class="btn-grapefruit" data-xianshi-goods-id="<%=xianshi_goods_id%>" href="javascript:void(0);"><i class="icon-trash"></i><p><?php echo $lang['nc_del'];?></p></a></span>
    <?php } ?>
    </td>
</tr>
</script> 
