...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=web_channel&op=web_channel" title="返回频道列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>频道管理 - 编辑“<?php echo $output['channel']['channel_name'];?>”频道模块</h3>
        <h5>商城的频道及模块内容管理</h5>
      </div>
    </div>
  </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic">
            ...
            选择分类后，频道顶部切换焦点大图右侧会自动调用该分类下的抢购和限时折扣促销商品，抢购的商品优先，无数据时不显示。<br/></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
