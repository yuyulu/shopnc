    ...
    <?php if (is_array($output['address_list']) && !empty($output['address_list'])){?>
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td class="tc"><a href="javascript:void(0);" nc_type="select" class="ncbtn" address_id="<?php echo $value['address_id'];?>" address_value="<?php echo $value['seller_name'].'&nbsp;'.$value['telphone'].'&nbsp;'.$value['area_info'].'&nbsp;'.$value['address'];?>"><?php echo $lang['nc_common_button_select'];?></a></td>
        </tr>
        <?php }?>
        <tr class="bd-line">
          <td colspan="20"></td>
