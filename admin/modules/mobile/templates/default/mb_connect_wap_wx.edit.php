...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>如果启用了PC端的微信登录，因接口返回数据不同会注册不同的会员账号，建议按微信文档操作，<a class="ncap-btn" target="_blank" href="http://mp.weixin.qq.com/wiki/4/9ac2e7b1f1d22e9e57260f6553822520.html">查看</a>。</li>
    </ul>
  </div>
  <form method="post" name="settingForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="wap_weixin_appid">应用标识</label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="wap_weixin_appkey">应用密钥</label>
        </dt>
        <dd class="opt">
