...
<form action="index.php?act=common&op=pic_cut" id="form_cut" method="post">
  ...
  <div class="pic-cut-<?php echo $_GET['x'].$_GET['type'];?>">
    ...
    <div class="cut-btn"> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="pic_submit"><i class="fa fa-scissors"></i><?php echo $lang['nc_submit'];?></span></a> </div>
  </div>
</form>
...
$(function(){
    ...
    $('#pic_submit').click(function(){
		...
		$.post('<?php echo ADMIN_SITE_URL?>/index.php?act=common&op=pic_cut',d,function(data){
			call_back(data);
