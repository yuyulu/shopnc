  ...
  <form id="delivery_joinin" method="post" enctype="multipart/form-data" action="<?php echo DELIVERY_SITE_URL?>/index.php?act=joinin&op=save_delivery">
    ...
    <dl class="r1">
      ...
      <dd>
        ...
        <input class="input-txt tip" type="text" name="dname" id="dname" title="3-15位字符，可由中文、英文、数字及“_”、“-”组成。">
        <span></span>
      </dd>
      <dd>
    ...
    <dl class="r3">
      <dt>申请人认证：</dt>
      <dd>
        <label class="phrases">真实姓名</label>
        <input class="input-txt tip w100" type="text" name="dtruename" id="dtruename" title="如实填写申请人的真实姓名，平台将严格保密，仅用于申请审核使用。">
        <span></span>
      </dd>
      <dd>
        <label class="phrases">身份证号码</label>
        <input class="input-txt tip w200" type="text" name="didcard" id="didcard" title="如实填写申请人18位身份证号码，平台将严格保密，仅用于申请审核使用。">
        <span></span>
      </dd>
      <dd>
    ...
    <dl class="r2">
      ...
      <dd>
        ...
        <input type="hidden" name="area_id_2" id="_area_2" value="">
        <input type="hidden" name="area_id_3" id="_area_3" value="">
        <input type="hidden" name="area_id_4" id="_area_4" value="">
        <input type="hidden" name="area_id" id="_area" value="" />
      </dd>
      <dd>
        <label class="phrases">详细地址</label>
        <input class="input-txt tip w400" type="text" name="daddress" id="daddress" title="服务站详细地址不需要重新填写省市区，必须大于5个字符，小于50个字符。">
        <span></span>
      </dd>
      <dd>
        <label class="phrases">联系用手机</label>
        <input class="input-txt tip" type="text" name="dmobile" id="dmobile" title="联系用手机将提供给收货人，方便自提咨询时联系。">
        <span></span>
      </dd>
      <dd>
        <label class="phrases">联系用固定电话</label>
        <input class="input-txt tip" type="text" name="dtelephony" id="dtelephony" title="联系用固定电话将提供给收货人，方便自提咨询时联系。">
        <span></span>
      </dd>
      
    </dl>
    <div style="text-align: center; padding: 10px 0;">
      <input type="submit" class="submit" value="入驻申请提交">
      <a href="index.php?act=login" class="login">已注册用户"登录管理"</a>
    </div>
  </form>
</div>
    ...
    $('#delivery_joinin').validate({
        ...
        rules : {
            dname : {
                ...
                rangelength : [3,15],
                lettersonly : true,
                remote   : 'index.php?act=joinin&op=check'
            },
            dpasswd : {
                required : true,
                rangelength : [6,20]
