...
<div class="fixed-bar">
  <div class="item-title"><a class="back" href="index.php?act=ownshop&op=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
    <div class="subject">
      <h3>自营店铺 - <?php echo $lang['nc_edit'];?>“<?php echo $output['store_info']['store_name'];?>”经营类目</h3>
      <h5>商城自营店铺相关设置与管理</h5>
    </div>
  </div>
</div>
...
<div class="ncap-form-default" >
  ...
  <div class="bot"><a id="btn_add_category" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);" /><span>确认提交</span></a></div>
</div>
