    ...
    <div class="ncs-goods-main">
      ...
      <div class="ncs-goods-info-content bd" id="ncGoodsRate">
        <div class="top" style="overflow: hidden;">
          ...
          <div class="ncs-cosult-askbtn"><a href="#askQuestion" class="ncbtn ncbtn-grapefruit">我要提问</a></div>
        </div>
        ...
        <div class="ncs-consult-form">
          ...
          <dl>
            ...
            <dd>
              ...
              <?php } ?>
              <a href="JavaScript:void(0);" nctype="consult_submit" title="<?php echo $lang['goods_index_publish_consult'];?>" class="ncbtn ncbtn-grapefruit"><?php echo $lang['goods_index_publish_consult'];?></a></dd>
      ...
      <div class="ncs-sidebar-container">
        ...
        <div class="content">
          <dl class="ncs-comment-goods">
            ...
            <dd class="goods-price"><?php echo $lang['goods_index_goods_price'].$lang['nc_colon'];?><em class="saleP"><?php echo $lang['currency'].ncPriceFormat($output['goods']['goods_promotion_price']);?></em></dd>
