...
<?php } ?>
    <dl>
      ...
      <dd> <a href="<?php echo urlShop('store_decoration', 'decoration_edit', array('decoration_id' => $output['decoration_id']));?>" class="ncbtn ncbtn-aqua mr5" target="_blank"><i class="icon-puzzle-piece"></i>装修页面</a> <a id="btn_build" href="<?php echo urlShop('store_decoration', 'decoration_build', array('decoration_id' => $output['decoration_id']));?>" class="ncbtn ncbtn-bittersweet" target="_blank"><i class="icon-magic"></i>生成页面</a>
