<?php defined('In33hao') or exit('Access Invalid!');?>
  <div class="visitors pngFix">
    ...
    <ul id="visit_me" nc_type="visitlist">
      ...
      <?php }?>
      <?php }else {?>
      <?php echo $lang['sns_visitme_tip_1'];?><a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_snsfriend&op=find"><?php echo $lang['sns_visitme_tip_2'];?></a><?php echo $lang['sns_visitme_tip_3'];?>
      <?php }?>
    </ul>
    ...
    <ul id="visit_other" nc_type="visitlist" style="display: none;">
      ...
      <?php }?>
      <?php }else {?>
      <?php echo $lang['sns_visitother_tip_1'];?><a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_snsfriend&op=follow"><?php echo $lang['sns_visitother_tip_2'];?></a><?php echo $lang['sns_visitother_tip_3'];?>
      <?php }?>
    </ul>
    <?php }?>
  </div>
