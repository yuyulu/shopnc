    ...
    <tr>
      ...
      <td class="w90">
        <select name="verify">
          ...
          <option <?php if (!empty($_GET['verify']) && $_GET['verify'] == $key) {?>selected<?php }?> value='<?php  echo $key;?>'><?php echo $val;?></option>
          <?php }?>
        </select>
      </td>
      <th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <?php if ($val['goods_verify'] == 0) {?><p><?php echo $val['goods_verifyremark'];?></p><?php }?>
      </td>
