...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncbtn ncbtn-mint" onclick="go('index.php?act=store_account&op=account_add');" title="添加账号">添加账号</a> </div>
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <td></td>
      ...
      <td class="tl"><?php echo $output['member_name_array'][$value['member_id']]['member_name'];?></td>
      <td><?php echo $output['seller_group_array'][$value['seller_group_id']]['group_name'];?></td>
      <td class="nscs-table-handle">
          <span><a href="<?php echo urlShop('store_account', 'account_edit', array('seller_id' => $value['seller_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
        <p><?php echo $lang['nc_edit'];?></p></a>
          </span><span><a nctype="btn_del_account" data-seller-id="<?php echo $value['seller_id'];?>" href="javascript:;" class="btn-grapefruit"><i class="icon-trash"></i>
