...
<div class="ncsc-flow-item">
  ...
  <div class="item-goods">
      ...
      <dl>
        ...
        <dd><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>"><?php echo $val['goods_name']; ?></a>
            <?php echo $lang['currency'];?><?php echo ncPriceFormat($val['goods_price']); ?> * <?php echo $val['goods_num']; ?> <font color="#AAA">(数量)</font>
  ...
  <div class="item-order">
    ...
    <dl class="line">
      <dt>订单编号：</dt>
      <dd><a target="_blank" href="index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
