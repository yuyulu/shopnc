      ...
      <tbody>
    	...
    	<tr id="row_<?php echo $k; ?>">
    		...
    		<td class="nscs-table-handle">
    			<span><a class="btn-grapefruit" href="JavaScript:void(0);" onclick="delrow(<?php echo $k;?>);"><i class="icon-trash"></i><p><?php echo $lang['nc_del']; ?></p></a></span>
    		</td>
    	</tr>
    	<?php } } else { ?>
    	<tr id="row_0">
    		...
    		<td class="nscs-table-handle">
    			<span><a class="btn-grapefruit" href="JavaScript:void(0);" onclick="delrow(0);"><i class="icon-trash"></i><p><?php echo $lang['nc_del']; ?></p></a></span>
    		</td>
    	</tr>
    	<?php } ?>
      </tbody>
...
$(function(){
	...
	$('#addrow').click(function(){
		...
		html += '<td class="nscs-table-handle"><span><a class="btn-grapefruit" href="JavaScript:void(0);" onclick="delrow('+i+');"><i class="icon-trash"></i><p><?php echo $lang['nc_del']; ?></p></a></span></td>';
