...
<ul class="goods-list">
  ...
  <li>
    ...
    <a nctype="a_choose_goods" data-gid='<?php echo $val['goods_id'];?>' data-type="book" href="javascript:void(0);" class="ncbtn-mini">定金预售</a> 
    <a nctype="a_choose_goods" data-gid='<?php echo $val['goods_id'];?>' data-type="presell" href="javascript:void(0);" class="ncbtn-mini">全款预售</a>
    </li>
  <?php } ?>
</ul>
