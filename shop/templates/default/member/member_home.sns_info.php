    ...
    <div class="outline">
      ...
      <?php if (!empty($output['follow_list']) && is_array($output['follow_list'])) { ?>
       <div class="ncm-friends-share">
            ...
            <div class="more"><a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_snsfriend&op=follow">查看我的全部好友</a></div>
          </div>
     <?php } else { ?>
      <dl class="null-tip">
        <dt></dt>
        <dd>
          ...
          <p><a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_snsfriend&op=follow" class="ncbtn-mini" >查看我的全部好友</a></p>
        </dd>
      </dl>
    <?php } ?>  
    </div>
    ...
    <?php if(!empty($output['circle_list'])){?>
      ...
      <dl class="null-tip">
        ...
        <dd>
          ...
          <p><a target="_blank" href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=index&op=add_group" class="ncbtn-mini">创建圈子</a></p>
        </dd>
      </dl>
      <?php } ?>
    </div>
