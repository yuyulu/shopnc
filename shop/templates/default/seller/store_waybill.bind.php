...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" class="btn-aqua" target="_blank"><i class="icon-print"></i>
        <p>测试</p>
        </a></span><span><a href="javascript:;" nctype="btn_bind" class="btn-mint" data-waybill-id="<?php echo $value['waybill_id'];?>"><i class="icon-link"></i>
        <p>绑定</p>
        </a></span></td>
    </tr>
    <?php }?>
