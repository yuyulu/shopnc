...
<div class="wrap">
  ...
  <div class="ncm-message-setting">
    <form method="post" action="<?php echo urlMember('member_message', 'setting');?>" id="setting_form" onsubmit="ajaxpost('setting_form', '', '', 'onerror');">
      ...
      <dl>
        ...
        <dd>
          <ul>
            ...
            <li>
              <input type="checkbox" name="order_book_end_pay" id="order_book_end_pay" value="1" <?php if ($output['setting_array']['order_book_end_pay'] || !isset($output['setting_array']['order_book_end_pay'])) {?>checked<?php }?> />
              <label for="vr_code_will_expire">预定订单尾款支付提醒</label></li>
          </ul>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <ul>
            ...
            <li>
              <input type="checkbox" name="rpt_use" id="rpt_use" value="1" <?php if ($output['setting_array']['rpt_use'] || !isset($output['setting_array']['rpt_use'])) {?>checked<?php }?> />
              <label for="voucher_use">平台红包使用提醒</label></li>
            <li>
