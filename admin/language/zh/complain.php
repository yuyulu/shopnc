 ...
 * 導航菜單
 */
$lang['complain_new_list'] = '新投訴';
$lang['complain_handle_list'] = '待仲裁';
$lang['complain_appeal_list'] = '待申訴';
$lang['complain_talk_list'] = '對話中';
$lang['complain_finish_list'] = '已關閉';
...
$lang['refund_seller_message']	= '賣家不同意原因';
$lang['refund_buyer_message']	= '申請退款原因';
$lang['refund_state_yes']	= '同意退款';

/**
 * 提示信息 
 */
$lang['confirm_delete'] = '您確定要刪除嗎?';
$lang['complain_content_error'] = '投訴內容不能為空且必須小於100個字元';
$lang['appeal_message_error'] = '投訴內容不能為空且必須小於100個字元';
$lang['complain_pic_error'] = '圖片必須是jpg格式';
$lang['complain_time_limit_error'] = '投訴時效不能為空且必須為數字';
...
$lang['complain_setting_save_success'] = '投訴設置保存成功';
$lang['complain_setting_save_fail'] = '投訴設置保存失敗';
$lang['complain_goods_select'] = '選擇要投訴的商品';
$lang['complain_submit_success'] = '投訴提交成功';
$lang['complain_close_confirm'] = '確認關閉此投訴?';
...
$lang['talk_forbit_success'] = '對話屏蔽成功';
$lang['talk_forbit_fail'] = '對話屏蔽失敗';
$lang['complain_verify_success'] = '投訴審核成功';
$lang['complain_verify_fail'] = '投訴審核失敗';
$lang['complain_close_success'] = '投訴關閉成功';
$lang['complain_close_fail'] = '投訴關閉失敗';
$lang['talk_forbit_message'] =  '<該對話被管理員屏蔽>';
$lang['handle_confirm_message'] = '確認提交仲裁,提交後管理員將做出裁決';
$lang['final_handle_message_error'] = '處理意見不能為空且必須小於255個字元';
$lang['final_handle_message'] = '處理意見';
$lang['handle_submit'] = '提交仲裁';
$lang['complain_repeat'] = '您已經投訴了該訂單請等待處理';
$lang['verify_submit_message'] = '確認審核此投訴';
...
$lang['complain_text_verify'] = '審核';
$lang['complain_text_close'] = '關閉投訴';
$lang['send_appeal_message'] = '被投訴人回覆了您的投訴';
$lang['send_accused_message'] = '您被投訴了';
$lang['complain_text_forbit'] = '屏蔽';
$lang['complain_help1']='在投訴時效內，買家和賣家都可對訂單進行投訴，投訴主題由管理員在後台統一設置';
$lang['complain_help2']='投訴時效可在系統設置處進行設置';
$lang['complain_help3']='點擊詳細，可進行投訴審核。審核完成後，被投訴人可進行申訴。申訴成功後，投訴雙方進行對話，最後由後台管理員進行仲裁操作';
