  ...
  <form method="post" action="index.php?act=store_callcenter&op=save" id="callcenter_form" onsubmit="ajaxpost('callcenter_form','','','onerror')" class="ncs-message">
    ...
    <dl nctype="pre">
      ...
      <dd>
        ...
        <?php }?>
        <?php }?>
        <p><span><a href="javascript:void(0);" onclick="add_service('pre');" class="ncbtn ncbtn-aqua mt10"><i class="icon-plus"></i><?php echo $lang['store_callcenter_add_service'];?></a></span></p>
      </dd>
    </dl>
    <dl nctype="after" >
      ...
      <dd>
        ...
        <div class="ncs-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span><a nctype="del" href="javascript:void(0);" class="ncbtn"><i class="icon-trash"></i><?php echo $lang['nc_delete'];?></a></span> </div>
        <?php }else{?>
        ...
        <?php }?>
        <?php }?>
        <p><span><a href="javascript:void(0);" onclick="add_service('after');" class="ncbtn ncbtn-aqua mt10"><i class="icon-plus"></i><?php echo $lang['store_callcenter_add_service'];?></a></span></p>
      </dd>
    </dl>
    <dl >
