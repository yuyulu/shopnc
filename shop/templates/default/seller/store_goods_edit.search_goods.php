...
<ul class="goods-list">
  ...
  <li>
    ...
    <a nctype="a_choose_goods" data-param="{gid:<?php echo $val['goods_id'];?>, gname:'<?php echo $val['goods_name'];?>', gimage:'<?php echo thumb($val, '60');?>', gimage240:'<?php echo thumb($val, '240');?>', gurl:'<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id']));?>', gprice:'<?php echo ncPriceFormat($val['goods_price']);?>'}" href="javascript:void(0);" class="ncbtn-mini ncbtn-mint"><i class="icon-plus"></i>添加商品</a> </li>
  <?php } ?>
</ul>
