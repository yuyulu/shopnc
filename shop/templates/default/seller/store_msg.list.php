  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all">全选</label>
        <a href="javascript:void(0);" nc_type="batchbutton" uri="<?php echo urlShop('store_msg', 'mark_as_read');?>" name="smids" class="ncbtn-mini"><i class="icon-flag"></i>标记为已读</a>
        <?php if ($_SESSION['seller_is_admin']) {?>
        <a href="javascript:void(0);" nc_type="batchbutton" uri="<?php echo urlShop('store_msg', 'del_msg')?>" name="smids" class="ncbtn-mini"><i class="icon-trash"></i>删除</a>
        <?php }?>
      </td>
    </tr>
  </thead>
