...
$lang['admin_add_username_tip']			= '3-15位字符，可由中文、英文、数字及“_”、“-”组成。';
$lang['admin_add_password_tip']			= '6-20位字符，可由英文、数字及标点符号组成。';
$lang['admin_add_rpassword_tip']		= '请再次输入您的密码。';
$lang['admin_add_gid_tip']				= '请选择一个权限组，如果还未设置，请先建立权限组后再添加管理员。';
