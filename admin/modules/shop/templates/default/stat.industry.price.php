...
<div class="page">
  ...
  <div class="ncap-stat-chart">
    ...
    <?php } else {?>
    <div class="no-date"><i class="fa fa-exclamation-triangle"></i>查看行业价格分布情况前，请先设置价格区间。<a href="index.php?act=stat_general&op=setting" class="ncap-btn ncap-btn-orange">马上设置</a></div>
    <?php } ?>
  </div>
