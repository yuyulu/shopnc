  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        ...
        <dd><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><?php echo $val['goods_name']; ?></a> <span class="rmb-price"><?php echo ncPriceFormat($val['goods_price']); ?>&nbsp;*&nbsp;<?php echo $val['goods_num']; ?>
