...
class specModel extends Model {
    ...
    public function getSpecInfo($id, $field = '*') {
        return $this->field($field)->where(array('sp_id'=>$id))->find();
    }
    ...
    private function getCondition($condition_array) {
        ...
        if ($condition_array['like_spec_id'] != '') {
            $condition_str .= " and sp_id like '%".$condition_array['like_spec_id']."%'";
        }
        if ($condition_array['like_spec_name'] != '') {
            $condition_str .= " and sp_name like '%".$condition_array['like_spec_name']."%'";
        }
