        ...
        <dd>
          <ul>
            ...
            <li>所需积分：
              ...
              <a href="javascript:searchrpt();" class="ncbtn">搜索</a> </li>
            <!-- 所需积分e -->
            <?php if($_SESSION['is_login'] == '1'){ ?>
            <li>
      ...
      <li>
        <div class="ncp-voucher">
          ...
          <div class="point">
            ...
            <p><em><?php echo $v['rpacket_t_giveout'];?></em>人兑换</p>
          ...
          <div class="button"><a target="_blank" href="javascript:;" nc_type="rptexchangebtn" data-param='{"tid":"<?php echo $v['rpacket_t_id'];?>"}' class="ncbtn ncbtn-grapefruit">立即兑换</a></div>
        </div>
      </li>
      <?php }?>
    </ul>
...
function searchrpt(){
	var url = 'index.php?act=pointredpacket&op=index';
