...
<div class="wrap">
  ...
  <div class="ncm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?act=member_bind&op=sinaunbind">
    ...
    <div class="revise ncm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?act=member_bind&op=sinaunbind">
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=connect_sina"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/sina_bind_small.gif"></a></p>
