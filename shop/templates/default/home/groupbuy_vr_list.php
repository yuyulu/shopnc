...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span> <span>虚拟抢购</span></div>
</div>
...
<?php } ?>
  ...
  <div class="ncg-topbar-wrapper">
  <div class="title">
      <?php if ($_GET['op'] == 'index' || strpos($_GET['op'], 'vr_groupbuy_') === 0) { ?>
      <div class="city"> 抢购地区【<a href="javascript:void(0)" id="button_show">
