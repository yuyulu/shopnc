    ...
    <div class="mainbox">
        ...
        <table class="base-table-style">
            ...
            <tr>
                ...
                <?php } ?>
                <td colspan="20">
                    <form method="get" class="manage-search-member">
            ...
            <?php if (!empty($output['cm_list'])) { ?>
                <?php foreach ($output['cm_list'] as $val) { ?>
                    <tr>
                        ...
                        <td>
                            <dl class="member-base">
                                <dt class="member-name"><a href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_snshome&mid=<?php echo $val['member_id']; ?>" target="_blank"><?php echo $val['member_name']; ?></a><?php echo memberIdentity($val['is_identity']); ?></dt>
                                <dd class="member-avatar-s"><img src="<?php echo getMemberAvatarForID($val['member_id']); ?>"/><?php if ($val['is_star']) {
                                        echo '<dd class="member-star" title="' . $lang['circle_stat_member'] . '"></dd>';
                                    } ?></dd>
                            </dl>
                        </td>
                        ...
                        <td class="time"><?php if (empty($val['cm_lastspeaktime'])) {
                                echo '--';
                            } else {
                                echo @date('Y-m-d', $val['cm_lastspeaktime']);
                            } ?></td>
                        <td><?php if ($val['is_allowspeak'] == 1) {
                                echo $lang['nc_allow'];
                            } else {
                                echo $lang['nc_ban'];
                            } ?></td>
