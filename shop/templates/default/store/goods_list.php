...
<div class="wrapper mt10">
  <div class="ncs-main-container">
    <div class="title">
      <h4><?php if(!empty($_GET['stc_id'])){echo $output['stc_name'];}elseif(!empty($_GET['inkeyword'])){echo $lang['show_store_index_include'].$_GET['inkeyword'].$lang['show_store_index_goods'];}else{ echo $lang['nc_whole_goods']; }?> </h4>
    </div>
