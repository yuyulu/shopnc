...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="reply_form1" action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=edit_reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['reply_info']['theme_id'];?>&r_id=<?php echo $output['reply_info']['reply_id'];?>">
