          ...
          <li class="item">
            ...
            <dl class="share-describe">
              ...
              <dd class="member-name">
                ...
                <h5 class="share-date"><?php echo $lang['nc_at'];?>
                  <?php if($val['share_isshare'] == 1){?>
                  <em><?php echo @date('Y-m-d H:i', $val['share_addtime']);?></em><?php echo $lang['nc_show'];?>
                  <?php }else{?>
                  <em><?php echo @date('Y-m-d H:i', $val['share_likeaddtime']);?></em><?php echo $lang['nc_like'];?>
                  <?php }?>
                </h5>
              </dd>
              <dd class="share-content"><i></i>
                <p>
                  <?php if($val['share_content'] != ''){echo $val['share_content'];}else{echo $lang['nc_share_default_content'];}?>
                </p>
