...
<?php if ($output['groupbuy_info']['is_vr']) { ?>
  <span><a href="<?php echo urlShop('show_groupbuy', 'vr_groupbuy_list'); ?>">虚拟抢购</a></span>
<?php } else { ?>
  <span><a href="<?php echo urlShop('show_groupbuy', 'groupbuy_list'); ?>">线上抢购</a></span>
<?php } ?>
    ...
    <div class="ncg-main <?php echo $output['groupbuy_info']['state_flag'];?>">
      <div class="ncg-group">
        ...
        <div class="ncg-item">
          ...
          <div class="button"><span><?php echo $lang['currency'];?><em><?php echo ncPriceFormat($output['groupbuy_info']['groupbuy_price']);?></em></span><a href="<?php echo $output['groupbuy_info']['goods_url'];?>" target="_blank"><?php echo $output['groupbuy_info']['button_text'];?></a></div>
          <div class="info" id="main-nav-holder">
            ...
            <div class="time time-remain" count_down="<?php echo $output['groupbuy_info']['count_down']; ?>">
