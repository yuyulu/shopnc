      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="tl"><dl class="goods-name">
              <dt><a href="<?php echo urlShop('goods','index',array('goods_id'=>$output['order_info']['goods_id']));?>" target="_blank" title="<?php echo $output['order_info']['goods_name'];?>"><?php echo $output['order_info']['goods_name'];?></a><a target="_blank" href="<?php echo urlShop('vr_snapshot', 'index', array('order_id' => $output['order_info']['order_id']));?>" class="blue ml5">[交易快照]</a></dt>
              <?php if ($output['order_info']['goods_spec']) { ?>
              <dd><?php echo $output['order_info']['goods_spec'];?></dd>
              <?php } ?>
              <dd>
          ...
          <td><?php echo ncPriceFormat($output['order_info']['goods_price']);?></td>
          <td><?php echo $output['order_info']['goods_num'];?></td>
          <td class="commis bdl bdr"><?php if ($output['order_info']['commis_rate'] != 200) { ?>
