...
<div class="wrap">
  ...
  <form action="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_information&op=upload" enctype="multipart/form-data" id="form_avaster" method="post">
  ...
  <?php }else{?>
  <form action="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_information&op=cut" id="form_cut" method="post">
    <input type="hidden" name="form_submit" value="ok" />
