    ...
    <div class="share-content">
      ...
      <div class="share-goods">
        ...
        <dl class="goods-intro">
          ...
          <dd><?php if (in_array($output['goods_info']['goods_promotion_type'], array(1,2))) {?><span><?php echo $output['goods_info']['goods_promotion_type'] == 1 ? '抢购' : '限时';?></span><?php }?><strong>￥<?php echo ncPriceFormat($output['goods_info']['goods_promotion_price']); ?></strong></dd>
        </dl>
      </div>
