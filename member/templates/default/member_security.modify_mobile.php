...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    <form method="post" id="mobile_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_security&op=modify_mobile">
      ...
      <dl>
        ...
        <p>
          ...
          <a href="javascript:void(0);" id="send_auth_code" class="ncbtn ml5"><span id="sending" style="display:none">正在</span><span class="send_success_tips"><strong id="show_times" class="red mr5"></strong>秒后再次</span>获取短信验证码</a></p>
