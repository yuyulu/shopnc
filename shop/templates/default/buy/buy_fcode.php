...
<div class="ncc-main">
  ...
  <div class="ncc-receipt-info">
    <div class="fcode-form ">
      ...
      <input type="hidden" id="goods_id" name="goods_id" value="<?php echo $output['store_cart_list'][key($output['store_cart_list'])][0]['goods_id'];?>">
    </div>
...
$(function(){
    $('#fcode_submit').on('click',function(){
        ...
        $('#fcode_callback').val('');
		$.get("index.php?act=buy&op=check_fcode", {'fcode':$('#fcode').val(),'goods_id':$('#goods_id').val()}, function(data){
            if (data == '1') {
