          ...
          <dd>
            ...
            <?php echo $lang['complain_pic_none'];?>
                <?php if((intval($output['complain_info']['complain_state']) < 99)) { ?>
                    <a class="ncbtn-mini ncbtn-bittersweet" href="javascript:void(0);" onclick="$('#post_add_pic_form').toggle();" title="<?php echo $lang['complain_add_pic'];?>"><i class="icon-cloud-upload "></i><?php echo $lang['complain_add_pic'];?></a>
