  ...
  <div class="topbar wrapper">
    ...
    <?php }else{?>
      ...
      <a href="<?php echo SHOP_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a>
       <span>[<a href="<?php echo urlLogin('login');?>"><?php echo $lang['nc_login'];?></a>]</span>
        <span>[<a href="<?php echo urlLogin('login','register');?>"><?php echo $lang['nc_register'];?></a>]</span>
    <?php }?></div>
  ...
  <div class="warp-all">
    ...
    <div class="circle-user">
      ...
      <div class="user-login">
        ...
        <?php }else{?>
        <a href="Javascript:void(0)" nctype="login"><?php echo $lang['nc_login'];?></a> | <a href="<?php echo urlLogin('login','register');?>"><?php echo $lang['nc_register'];?></a>
        <?php }?>
      </div>
    </div>
  </div>
