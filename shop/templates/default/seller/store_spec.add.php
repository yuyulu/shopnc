...
<form id="spec_form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php?act=store_spec&op=save_spec">
  ...
  <div class="ncsc-spec-info" style=" width: 960px;"><span>规格名称：<?php echo $output['sp_info']['sp_name'];?></span><span>所属分类：<?php echo $output['gc_info']['gc_name'];?></span><a href="javascript:void(0);" nctype="add_sv" class="ncbtn"><i class="icon-th-list"></i>添加规格值</a></div>
      ...
      <table class="ncsc-default-table">
        <tbody nctype="spec_tbody">
          ...
          <tr class="bd-line">
            ...
            <?php }?>
            <td class="w110 nscs-table-handle"><span><a href="javascript:void(0);" class="btn-grapefruit" nctype="spec_del" data-param="{id:<?php echo $value['sp_value_id'];?>}"><i class="icon-trash"></i>
              <p>删除</p>
              </a></span></td>
          </tr>
          <?php }?>
          ...
          <tr class="bd-line">
            ...
            <?php }?>
            <td class="w110 nscs-table-handle"><span><a href="javascript:void(0);" class="btn-bittersweet" nctype="tr_remove"><i class="icon-minus-sign"></i>
              <p>移除</p>
              </a></span></td>
          </tr>
          <?php }?>
...
$(function(){
    ...
    $('a[nctype="add_sv"]').click(function(){
        ...
        $('<td class="w110 nscs-table-handle"><span><a href="javascript:void(0);" class="btn-bittersweet"><i class="icon-minus-sign"></i><p>移除</p></a</span></td>').find('a').click(function(){
            $(this).parents('tr:first').remove();
        }).end().appendTo(_tr);   // 操作
