  ...
  <div class="ncsc-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="ncsc-form-default">
        ...
        <?php } ?>
        <div class="bottom">
            <label class=""><a href="javascript:history.go(-1);" class="ncbtn"><i class="icon-reply"></i>返回列表</a></label>
        </div>
      </div>
    </div>
  </div>
...
$(function(){
	$.getJSON('index.php?act=seller_center&op=get_express&e_code=<?php echo $output['e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&t=<?php echo random(7);?>',function(data){
		if(data){
