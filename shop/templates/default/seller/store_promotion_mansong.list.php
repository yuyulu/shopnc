...
<?php if ($output['isOwnShop']) { ?>
  <a class="ncbtn ncbtn-mint" href="<?php echo urlShop('store_promotion_mansong', 'mansong_add');?>"><i class="icon-plus-sign"></i><?php echo $lang['mansong_add'];?></a>

<?php } else { ?>

  <?php if(!empty($output['current_mansong_quota'])) { ?>
  <a class="ncbtn ncbtn-mint" style="right:100px" href="<?php echo urlShop('store_promotion_mansong', 'mansong_add');?>"><i class="icon-plus-sign"></i><?php echo $lang['mansong_add'];?></a> <a class="ncbtn ncbtn-aqua" href="<?php echo urlShop('store_promotion_mansong', 'mansong_quota_add');?>" title=""><i class="icon-money"></i>套餐续费</a>
  <?php } else { ?>
  <a class="ncbtn ncbtn-aqua" href="<?php echo urlShop('store_promotion_mansong', 'mansong_quota_add');?>" title=""><i class="icon-money"></i>购买套餐</a>
  <?php } ?>
<?php } ?>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?act=store_promotion_mansong&op=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-bluejeans"><i class="icon-th-list"></i>
        <p><?php echo $lang['nc_detail'];?></p>
        </a></span> <span><a nctype="btn_mansong_del" data-mansong-id="<?php echo $val['mansong_id'];?>" href="javascript:return void(0)" class="btn-grapefruit"><i class="icon-trash"></i>
