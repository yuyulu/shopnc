    ...
    <input type="hidden" name="p_id" value="<?php echo $output['plate_info']['plate_id'];?>"/>
        ...
        <dl>
          ...
          <dd>
            ...
            <p class="hr8">
              <a class="ncbtn" nctype="show_desc" href="index.php?act=store_album&op=pic_list&item=des"><i class="icon-picture"></i>插入相册图片</a>
              <a href="javascript:void(0);" nctype="del_desc" class="ncbtn ml5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a>
            </p>
            <p id="des_demo"></p>
          </dd>
        </dl>
