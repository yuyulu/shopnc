...
<div class="ncc-main">
  ...
  <div class="ncc-finish-c mb30"><a href="<?php echo SHOP_SITE_URL?>" class="ncbtn-mini ncbtn-mint mr15"><i class="icon-shopping-cart"></i>继续购物</a><a href="<?php echo SHOP_SITE_URL?>/index.php?act=member_order" class="ncbtn-mini ncbtn-aqua"><i class="icon-file-text-alt"></i>查看订单</a></div>
  </div>
</div>