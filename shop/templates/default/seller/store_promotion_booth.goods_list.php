...
<?php } else { ?>
  ...
  <a class="ncbtn ncbtn-aqua" href="<?php echo urlShop('store_promotion_booth', 'booth_quota_add');?>" title="购买套餐"><i class="icon-money"></i>购买套餐</a>
  <?php } else { ?>
  ...
  <?php } ?>
  <a class="ncbtn ncbtn ncbtn-aqua" href="<?php echo urlShop('store_promotion_booth', 'booth_renew');?>"><i class="icon-money"></i>套餐续费</a>
  <?php } ?>
<?php } ?>
        ...
        $.getJSON(_url, {gid : data_str.gid}, function(data){
            if (data.result == 'true') {
                ...
                $('<tr class="bd-line"></tr>')
                    ...
                    .append('<td class="nscs-table-handle"><span><a class="btn-grapefruit" href="javascript:void(0);" data-param="{gid:'+ data.goods_id +'}" nctype="del_choosed"><i class="icon-trash"></i><p>删除</p></a></span></td>')
