...
<div class="alert alert-block hr32">
  ...
  <div>
    ...
    <a class="ncbtn ncbtn-mint ml30" href="<?php echo urlShop('store_goods_online', 'add_gift', array('commonid' => $_GET['commonid'], 'ref_url' => urlShop('store_goods_online', 'index')));?>"><i class="icon-gift"></i>为该商品添加赠品捆绑</a>
    <?php }?>
  </div>
  <div class="hr16"></div>
  <strong>
