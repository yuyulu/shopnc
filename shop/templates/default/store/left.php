      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id']));?>"><span class="thumb size60"><i></i><img src="<?php echo thumb($val, 60);?>"  onload="javascript:DrawImage(this,60,60);"></span></a>
    ...
    <div id="hot_collect_list" class="ncs-top-panel hide">
      ...
      <ol>
        ...
        <li>
          <dl>
            <dt><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id']));?>"><?php echo $val['goods_name']?></a></dt>
            <dd class="goods-pic"><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$val['goods_id']));?>" title=""><span class="thumb size60"><i></i> <img src="<?php echo thumb($val, 60);?>" onload="javascript:DrawImage(this,60,60);"></span></a>
              <p><span class="thumb size100"><i></i><img src="<?php echo thumb($val, 240);?>" onload="javascript:DrawImage(this,100,100);" title="<?php echo $val['goods_name']?>"><big></big><small></small></span></p>
            </dd>
            <dd class="price pngFix"><?php echo ncPriceFormat($val['goods_promotion_price']);?></dd>
