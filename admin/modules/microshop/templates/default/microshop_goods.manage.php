  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        ...
        <h5><?php echo $lang['nc_microshop_goods_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function() {
    var flexUrl = 'index.php?act=goods&op=goods_manage_xml';
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            {display: '排序', name: 'microshop_sort', width: 60, sortable: false, align: 'left'},
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?act=goods&op=goods_drop&commend_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$('a[data-ie-column]').live('click', function() {
    $.get('index.php?act=goods&op=ajax&branch=goods_commend', {
...
$("span[data-live-inline-edit='microshop_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?act=goods&op=goods_sort_update', {
            id: $this.parents('tr').attr('data-id'),
            value: v2
        }, function(d) {
            if (d.result) {
