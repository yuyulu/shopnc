...
<div class="tabmenu">
  ...
  <a title="建立模板" class="ncbtn ncbtn-mint" href="<?php echo urlShop('store_waybill', 'waybill_add');?>">添加模板</a> </div>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_waybill', 'waybill_design', array('waybill_id' => $value['waybill_id']));?>" class="btn-bittersweet"><i class="icon-edit"></i>
        <p>设计</p>
        </a></span><span><a href="<?php echo urlShop('store_waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" class="btn-aqua" target="_blank"><i class="icon-print"></i>
        <p>测试</p>
        </a></span><span><a href="<?php echo urlShop('store_waybill', 'waybill_edit', array('waybill_id' => $value['waybill_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
        <p>编辑</p>
        </a></span><span><a href="javascript:;" nctype="btn_del" data-waybill-id="<?php echo $value['waybill_id'];?>" class="btn-grapefruit"><i class="icon-trash"></i>
        <p>删除</p>
        </a></span></td>
    </tr>
    <?php }?>
