...
<div class="ncsc-store-templet">
  <dl class="current-style">
    ...
    <dd><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']));?>" class="ncbtn"><?php echo $lang['store_theme_homepage'];?></a></dd>
  </dl>
    ...
    <ul>
      ...
      <li>
        <dl>
          ...
          <dd class="btn"> <a href="javascript:use_theme('<?php echo $theme['name'];?>','<?php echo $theme['truename'];?>');" class="ncbtn"><i class="icon-cogs"></i><?php echo $lang['store_theme_use'];?></a> <a href="javascript:preview_theme('<?php echo $theme['name'];?>');" class="ncbtn"><i class="icon-zoom-in"></i><?php echo $lang['store_theme_preview'];?></a> </dd>
        </dl>
      </li>
      <?php }?>
    </ul>
