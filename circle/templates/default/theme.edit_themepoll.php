...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="theme_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=edit_theme&sp=1&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; ?>">
...
$(function(){
    ...
    $('#theme_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('theme_form', CIRCLE_SITE_URL+'/index.php?act=theme&op=edit_theme&sp=1&c_id='+c_id+'&t_id='+t_id, '', 'onerror');
    	},
        rules : {
        	name : {
                required : true,
