...
<ul>
  ...
  <li>
    <label>
      <input type="radio" <?php echo $_GET['dlyp_id'] == $v['dlyp_id'] ? 'checked' : null; ?> nctype="dlyp_radio" data_area="<?php echo str_replace(' ', '', $v['dlyp_area_info']).$v['dlyp_address'];?>" value="<?php echo $v['dlyp_id'];?>" name="dlyp_id">
